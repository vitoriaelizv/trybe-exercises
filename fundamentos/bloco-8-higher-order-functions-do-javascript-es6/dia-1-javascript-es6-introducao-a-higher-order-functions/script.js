...
const dragonDamage = () => {
    let numRandom = Math.floor(Math.random() * (dragon.strength - 15 + 1)) + 15;
    return numRandom;
}
...
const warriorDamage = () => {
    let numRandom = Math.floor(Math.random() * (warrior.strength * warrior.weaponDmg - warrior.strength)) + warrior.strength;
    return numRandom;
}
